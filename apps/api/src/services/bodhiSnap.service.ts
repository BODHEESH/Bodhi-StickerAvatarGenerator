...
const promptTemplates: Record<StyleType, string> = {
  retro: "Convert the person in this image to a collectible figure in the BodhiSnap style with vintage color palette, film grain, saturated highlights, stylized toy look, 80s pop vibe. Maintain facial identity and natural skin tone. Make the figure look like a high-gloss designer toy with a slightly exaggerated head, glossy eyes, simplified clothing detail, and clean silhouettes. Render with a transparent background, high detail, no text.",
  
  miniature: "Convert the person in this image to a collectible miniature figure in the BodhiSnap style. Maintain facial identity and natural skin tone. Make the figure look like a high-gloss designer toy with a slightly exaggerated head, glossy eyes, simplified clothing detail, and clean silhouettes. Render with a transparent background, high detail, no text.",
  
  cartoon: "Convert the person in this image to a cartoon character in the BodhiSnap style. Maintain facial identity and natural skin tone. Use playful proportions, bright colors, and simplified features. Create a fun, animated look with clean lines and expressive features. Render with a transparent background, high detail, no text."
};
...
export const bodhiSnapService = {
  /**
   * Mock implementation of the BodhiSnap API
  ...
  generateStickers: async (
    ...
    // In a real implementation, we would call the BodhiSnap API here
