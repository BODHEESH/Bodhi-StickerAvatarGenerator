                ...
                <div className="flex justify-center">
                  <div className="w-48 h-48 bg-gray-100 rounded-lg overflow-hidden">
                    <img 
                      ...
                      onError={(e) => {
                        console.error('Failed to load original image:', stickerData.originalImage);
                        const target = e.currentTarget;
                        target.style.display = 'none';
                        // Show fallback message
                        const parent = target.parentElement;
                        if (parent) {
                          parent.innerHTML = '<div class="flex items-center justify-center h-full text-gray-500"><span>Original image unavailable</span></div>';
                        }
                      }}
